...
subroutine Atm_Hg_GasChem3
    ...
    Nform=Noxid+1
    !iForm(1:9)=(/Hg0,HgBr,HgBr2,HgBrOH,HgBrOOH,HgBrONO,HOHg,HOHgOOH,HOHgONO/)
    iForm(1:19)=(/HgBr,HgBr2,HgBrCl,HgBrONO,HgBrOOH,HgBrOH,HgBrO,HgO,HgOH,&
            &HgOH2,HgOHOOH,HgOHOOH,HgOHO,HgCl,HgCl2,HgOHCl,HgClONO,HgClOOH,HgClO/)
...
end subroutine Atm_Hg_GasChem3
